package com.example.webfluxmongodbfunctional.handler;

import com.example.webfluxmongodbfunctional.model.Hotel;
import com.example.webfluxmongodbfunctional.repository.HotelRepository;
...
public class HotelHandler {
    ...
    public Mono<ServerResponse> getAll(ServerRequest request) {
        ...
        return ServerResponse.ok().contentType(MediaType.APPLICATION_JSON).body(hotels, Hotel.class);
    }
    ...
    public Mono<ServerResponse> getHotel(ServerRequest request) {
        ...
        return hotelMono.flatMap(hotel -> ServerResponse.ok().contentType(MediaType.APPLICATION_JSON)
